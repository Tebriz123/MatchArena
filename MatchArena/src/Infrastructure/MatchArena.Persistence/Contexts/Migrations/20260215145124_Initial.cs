        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameFormat = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fields_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FieldRatings_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldRatings_FieldId",
                table: "FieldRatings",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldRatings_PlayerId",
                table: "FieldRatings",
                column: "PlayerId");
